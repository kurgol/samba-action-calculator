//
//  SACiPhoneTableViewController.m
...
#import "SACiPhoneTableViewController.h"
#import "SACAppDelegate.h"
#import "SACSequenceViewController.h"

@interface SACiPhoneTableViewController ()

@property SACAppDelegate* appDelegate;

@end

@implementation SACiPhoneTableViewController
...
- (void)viewDidLoad
{
    ...
    // Get the players from the AppDelegate class
